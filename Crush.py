    ...
    if in_group == 'yes':
        ...
        if dated_in_group == 'yes':
            ...
            if question == '1':
                ...
                if serious_level in range(1, 3):
                    idk()
                elif serious_level in range(3, 6):
                    calculate_cady_law()
                elif serious_level == 0:
    ...
    while True:
        ...
        match question:
            ...
            case 'no':
                ...
                if question == 'online':
                    print('\nPlaceholder for online scenario. \n')
                    ...
                    match question:
                        ...
                        case 'other':
                            print('\nPlaceholder for other scenario. \n')
            case 'yes':
                print('\nCooked, move on. Why were you liking them in the first place? \n')
                time.sleep(3)
                exit()
